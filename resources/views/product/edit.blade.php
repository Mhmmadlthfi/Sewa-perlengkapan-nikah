...
@section('container')
   <div class="container-xxl flex-grow-1 container-p-y">
      <h5 class="fw-bold py-3 mb-4">
         <span class="text-muted fw-light">Produk /</span> Edit Data Produk
      </h5>
                  ...
                  <div class="row mb-3">
                     ...
                     <div class="col-sm-10">
                        <input type="number"
                           ...
                           value="{{ old('stock', $product->stock) }}" autocomplete="stock"
                           required />
                        @error('stock')
                           <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                     ...
                     <div class="col-sm-10">
                        ...
                        @if (!$errors->has('image_url'))
                           <div id="imageHelp" class="form-text">
                              Biarkan kosong jika tidak ingin update foto. Ukuran maks foto
                              adalah 3MB.
                           </div>
                        @endif
                     </div>
                  ...
                  <div class="row mb-3">
                     ...
                     <div class="col-sm-10">
                        ...
                        <input id="description" type="hidden" name="description"
                           value="{{ old('body', $product->description) }}">
